...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Данные отсутствуют в таблице",sInfo:"Показано _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Показано 0 до 0 из 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Совпадающих записей не найдено"},
